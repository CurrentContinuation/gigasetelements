...
public class JsonToMapImpl
    ...
    @SuppressWarnings("unchecked")
    private void _visit(Map<String, Object> map, MapVisitor visitor, int level) throws IllegalAccessException, InvocationTargetException, Exception {
	...
	for (String key : map.keySet()) {
		...
		if (isMap && getMethod(visitor, "onKeyValue", int.class, String.class, Map.class) != null) {
		    getMethod(visitor, "onKeyValue", int.class, String.class, Map.class).invoke(visitor, level, key, value);
		} else if (isList && getMethod(visitor, "onKeyValue", int.class, String.class, List.class) != null) {
		    getMethod(visitor, "onKeyValue", int.class, String.class, List.class).invoke(visitor, level, key, value);
		} else if (isCollection && getMethod(visitor, "onKeyValue", int.class, String.class, Collection.class) != null) {
		    getMethod(visitor, "onKeyValue", int.class, String.class, Collection.class).invoke(visitor, level, key, value);
		} else if (getMethod(visitor, "onKeyValue", int.class, String.class, Object.class) != null) {
		    getMethod(visitor, "onKeyValue", int.class, String.class, Object.class).invoke(visitor, level, key, value);
		}
