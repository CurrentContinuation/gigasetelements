...
public abstract class GigasetElementsBase
    ...
    private synchronized Base base() {
	return base;
    }
	...
	decorate(targetAuth);
	Response responseAuth = targetAuth.request(MediaType.TEXT_PLAIN_TYPE).cookie(getFirstCookie(responseIdentity)).get();
	report(responseAuth);
